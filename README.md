...
- [WePY ★12k+](https://github.com/Tencent/wepy) -  支持组件化的小程序开发框架
- [mpvue ★11k+](https://github.com/Meituan-Dianping/mpvue) - 基于 Vue.js 的小程序开发框架，从底层支持 Vue.js 语法和构建工具体系
...
- [简易计算器]https://github.com/dunizb/wxapp-sCalc   -简易计算器
- [一起吧together](https://github.com/dmego/together) -一起吧
- [微信小程序github名片](https://github.com/monkindey/wx-github)  -微信小程序github名片
